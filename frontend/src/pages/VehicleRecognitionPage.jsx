  ...
  return (
    <div className="flex-1 flex flex-col min-h-screen bg-slate-950">
      ...
      <main className="flex-1 p-6 space-y-6 max-w-7xl mx-auto w-full">
        ...
        <div className="bg-slate-900/90 rounded-xl border border-slate-800 p-3 backdrop-blur-md flex flex-wrap items-center justify-between gap-3 text-xs">
          <div className="flex items-center gap-2">
            <span className="w-2.5 h-2.5 rounded-full bg-emerald-500 animate-pulse" />
            <span className="font-bold text-white uppercase tracking-wider text-[11px]">Industrial ANPR Control Room</span>
            <span className="text-slate-500">|</span>
            <span className="text-slate-400">Live Telemetry & Gate Automation Engine</span>
          </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
          <div className="bg-slate-900/80 rounded-xl p-3.5 border border-slate-800 backdrop-blur-md space-y-1">
        ...
        <div className="bg-slate-900/60 rounded-xl border border-slate-800 p-4 backdrop-blur-md space-y-4">
          ...
          {activeTab === 'upload' && (
            <div className="bg-slate-950/80 rounded-xl p-4 border border-slate-800 space-y-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3 text-xs">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 bg-slate-900 border border-slate-800 rounded-lg text-white text-xs focus:border-cyan-500 focus:outline-none"
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 bg-slate-900 border border-slate-800 rounded-lg text-white text-xs focus:border-cyan-500 focus:outline-none placeholder-slate-600"
                  />
                </div>
                <div>
                  <label className="block text-slate-400 mb-1 font-medium flex items-center gap-1">
              ...
              <div className="flex items-center gap-3 pt-2">
                <div
                  className="flex-1 border border-dashed border-slate-800 rounded-lg p-3 text-center cursor-pointer hover:border-cyan-500/50 bg-slate-900/40 flex items-center justify-between"
                ...
                >
                  ...
                  <span className="text-[10px] text-slate-500 font-mono">JPG, PNG, MP4, AVI</span>
                </div>

                <button
                  onClick={handleUpload}
                  disabled={!selectedFile || isUploading}
                  className="px-5 py-2.5 bg-cyan-600 hover:bg-cyan-500 disabled:bg-slate-800 text-white rounded-lg text-xs font-semibold shadow-lg shadow-cyan-600/20 transition-all flex items-center gap-2 flex-shrink-0"
                >
                  {isUploading ? (
                ...
                {selectedFile && (
                  <button
                    ...
                    className="px-3 py-2.5 bg-slate-800 hover:bg-slate-700 text-slate-300 rounded-lg text-xs transition-all"
                  >
                    Clear
                  </button>
                )}
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-slate-900/80 rounded-xl border border-slate-800 p-5 backdrop-blur-md space-y-4">
                ...
                <div className="bg-slate-950 rounded-lg p-2 border border-slate-800 flex justify-center min-h-[160px] items-center">
                ...
                <div className="grid grid-cols-2 gap-2 text-xs">
                  <div className="bg-slate-950 p-2.5 rounded border border-slate-800/80">
                    ...
                    <p className="font-semibold text-white">{result?.vehicle_type || 'Unknown'}</p>
                  </div>
                  <div className="bg-slate-950 p-2.5 rounded border border-slate-800/80">
                    <p className="text-[10px] text-slate-500">Vehicle Status</p>
                    <p className="font-semibold text-emerald-400">{result?.direction === 'Exiting' ? 'EXITING' : 'ENTERING'}</p>
                  </div>
                  <div className="bg-slate-950 p-2.5 rounded border border-slate-800/80">
                    <p className="text-[10px] text-slate-500">First Seen</p>
                    <p className="font-mono text-slate-300 text-[11px]">{result?.first_seen_at ? new Date(result.first_seen_at).toLocaleTimeString() : 'N/A'}</p>
                  </div>
                  <div className="bg-slate-950 p-2.5 rounded border border-slate-800/80">
                    <p className="text-[10px] text-slate-500">Camera Feed</p>
              ...
              <div className="bg-slate-900/80 rounded-xl border border-cyan-500/40 p-5 backdrop-blur-md space-y-4 flex flex-col justify-between">
                <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                ...
                <div className="bg-slate-950 p-4 rounded-xl border border-cyan-500/30 text-center space-y-2">
                  <p className="text-[10px] text-slate-500 uppercase tracking-wider font-semibold">Full Recognized License Plate</p>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-xs">
                  <div className="bg-slate-950 p-2 rounded border border-slate-800">
                    <p className="text-[9px] text-slate-500">Raw OCR</p>
                    <p className="font-mono text-slate-300 font-bold truncate">{result?.ocr_raw_text || result?.raw_ocr || result?.plate_text || 'N/A'}</p>
                  </div>
                  <div className="bg-slate-950 p-2 rounded border border-slate-800">
                    <p className="text-[9px] text-slate-500">OCR Confidence</p>
              ...
              <div className="bg-slate-900/80 rounded-xl border border-slate-800 p-5 backdrop-blur-md space-y-4">
                ...
                <div className="space-y-2 text-xs">
                  <div className="bg-slate-950 p-3 rounded-lg border border-slate-800 space-y-1">
                    <p className="text-[10px] text-slate-500">Active Barrier Gate</p>
                  ...
                  <div className="bg-slate-950 p-2.5 rounded border border-slate-800">
                    <p className="text-[10px] text-slate-500">Entry Timestamp</p>
                  ...
                  <div className="bg-slate-950 p-3 rounded-lg border border-slate-800 flex items-center justify-between">
                    <span className="text-[10px] text-slate-500">Gate Authorization</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-slate-900/80 rounded-xl border border-purple-500/30 p-5 backdrop-blur-md space-y-4">
                <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                ...
                <div className="grid grid-cols-2 gap-3 text-xs">
                  ...
                  <div className="bg-slate-950 p-3 rounded-lg border border-slate-800 space-y-1">
                    <p className="text-[10px] text-slate-500">Trip Purpose</p>
                    <p className="font-semibold text-slate-200">{result?.trip_details?.purpose || purpose || 'N/A'}</p>
                  </div>
                  <div className="bg-slate-950 p-3 rounded-lg border border-slate-800 space-y-1">
                    <p className="text-[10px] text-slate-500">Transporter</p>
                    <p className="font-semibold text-slate-200">{result?.transporter_details?.company_name || result?.transporter_details?.name || 'Unknown'}</p>
                  </div>
                  <div className="bg-slate-950 p-3 rounded-lg border border-slate-800 space-y-1">
                    <p className="text-[10px] text-slate-500">Driver</p>
                    <p className="font-semibold text-slate-200">{result?.driver_details?.name || 'Unassigned'}</p>
                  </div>
                  <div className="bg-slate-950 p-3 rounded-lg border border-slate-800 space-y-1">
                    <p className="text-[10px] text-slate-500">Destination</p>
                    <p className="font-semibold text-slate-200">{result?.trip_details?.destination || 'N/A'}</p>
                  </div>
                  <div className="bg-slate-950 p-3 rounded-lg border border-slate-800 space-y-1">
                    <p className="text-[10px] text-slate-500">Expected Exit Gate</p>
                    <p className="font-semibold text-slate-200">{result?.trip_details?.expected_exit_gate || 'N/A'}</p>
                  </div>
                </div>
              </div>

              {/* RIGHT CARD — AUTHORIZATION */}
              <div className="bg-slate-900/80 rounded-xl border border-emerald-500/30 p-5 backdrop-blur-md space-y-4">
                <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                ...
                <div className="bg-slate-950 p-3 rounded-lg border border-slate-800 space-y-1 text-xs">
                  <p className="text-[10px] text-slate-500">Authorization Rule Decision</p>
                ...
                <div className="grid grid-cols-3 gap-2 text-xs">
                  <div className="bg-slate-950 p-2.5 rounded border border-slate-800">
                    <p className="text-[10px] text-slate-500">Expected Transporter</p>
                    <p className="font-semibold text-slate-200 truncate">{result?.transporter_details?.company_name || 'Unknown'}</p>
                  </div>
                  <div className="bg-slate-950 p-2.5 rounded border border-slate-800">
                    <p className="text-[10px] text-slate-500">Expected Driver</p>
                    <p className="font-semibold text-slate-200 truncate">{result?.driver_details?.name || 'Unassigned'}</p>
                  </div>
                  <div className="bg-slate-950 p-2.5 rounded border border-slate-800">
                    <p className="text-[10px] text-slate-500">Expected Destination</p>
                    <p className="font-semibold text-slate-200 truncate">{result?.trip_details?.destination || 'N/A'}</p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-slate-900/80 rounded-xl border border-slate-800 p-5 backdrop-blur-md space-y-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 text-xs font-mono text-center pt-2">
                <div className="bg-slate-950 p-3 rounded-lg border border-cyan-500/30 space-y-1">
                  ...
                  <p className="text-white font-bold">{result?.first_seen_at ? new Date(result.first_seen_at).toLocaleTimeString() : '10:22:07 AM'}</p>
                  <p className="text-[10px] text-emerald-400">✓ Gate #1</p>
                </div>
                <div className="bg-slate-950 p-3 rounded-lg border border-purple-500/30 space-y-1">
                  <p className="text-[10px] text-purple-400 font-bold">2. VEHICLE INSIDE</p>
                  <p className="text-white font-bold">10:22:15 AM</p>
                ...
                <div className="bg-slate-950 p-3 rounded-lg border border-amber-500/30 space-y-1">
                  ...
                  <p className="text-[10px] text-slate-400">Yard Movement</p>
                </div>
                <div className="bg-slate-950 p-3 rounded-lg border border-slate-800 space-y-1">
                  <p className="text-[10px] text-slate-500 font-bold">4. EXIT</p>
            ...
            {/* ROW 5 — STAY DURATION */}
            <div className="bg-slate-900/80 rounded-xl border border-amber-500/30 p-5 backdrop-blur-md space-y-4">
              <div className="flex items-center justify-between border-b border-slate-800 pb-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-4 gap-3 text-xs">
                <div className="bg-slate-950 p-3 rounded-lg border border-slate-800 space-y-1 sm:col-span-2">
                  <p className="text-[10px] text-slate-500">Time Inside / Duration</p>
            ...
            <div className="bg-slate-900/90 rounded-xl border border-emerald-500/30 p-3.5 backdrop-blur-md space-y-2">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-2 text-xs text-center font-mono">
                <div className="bg-slate-950 p-2 rounded border border-slate-800">
                  <p className="text-[9px] text-slate-500">RAW OCR</p>
                  <p className="text-slate-300 font-bold truncate">{result?.ocr_raw_text || result?.plate_text || '03 ACU 808'}</p>
                </div>
                <div className="bg-slate-950 p-2 rounded border border-slate-800">
                  <p className="text-[9px] text-slate-500">FINAL PLATE</p>
                ...
                <div className="bg-slate-950 p-2 rounded border border-slate-800">
                  <p className="text-[9px] text-slate-500">OCR CONSENSUS</p>
                  <p className="text-emerald-400 font-bold">98.7%</p>
                </div>
                <div className="bg-slate-950 p-2 rounded border border-slate-800">
                  <p className="text-[9px] text-slate-500">PLATE MATCH</p>
                  <p className="text-emerald-400 font-bold">1.00</p>
                </div>
                <div className="bg-slate-950 p-2 rounded border border-slate-800">
                  <p className="text-[9px] text-slate-500">DUPLICATES</p>
            ...
            <div className="bg-slate-900/80 rounded-xl border border-slate-800 overflow-hidden backdrop-blur-md space-y-3 p-5">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left text-xs font-mono">
                  <thead>
                    <tr className="border-b border-slate-800 text-slate-500 uppercase text-[10px] tracking-wider bg-slate-950/60">
                  ...
                  <tbody className="divide-y divide-slate-800/60">
                    <tr className="hover:bg-slate-800/30 transition-all">
                      <td className="py-2.5 px-3 text-slate-400">10:22</td>
                      <td className="py-2.5 px-3 text-cyan-400 font-bold">{result?.plate_text || '03 ACU 808'}</td>
                      <td className="py-2.5 px-3 text-slate-300">{result?.vehicle_type || 'Car'}</td>
                      <td className="py-2.5 px-3 text-slate-400">Gate #1</td>
                    ...
                    <tr className="hover:bg-slate-800/30 transition-all">
                      <td className="py-2.5 px-3 text-slate-400">10:18</td>
                      <td className="py-2.5 px-3 text-cyan-400 font-bold">TN38AB1234</td>
                      <td className="py-2.5 px-3 text-slate-300">Truck</td>
                      <td className="py-2.5 px-3 text-slate-400">Gate #1</td>
                      <td className="py-2.5 px-3 text-cyan-300 font-bold">ENTRY</td>
                      <td className="py-2.5 px-3">
                        <span className="px-2 py-0.5 bg-emerald-500/20 text-emerald-300 border border-emerald-500/40 rounded text-[10px]">
                    ...
                    <tr className="hover:bg-slate-800/30 transition-all">
                      <td className="py-2.5 px-3 text-slate-400">09:54</td>
                      <td className="py-2.5 px-3 text-cyan-400 font-bold">KA01XY9087</td>
                      <td className="py-2.5 px-3 text-slate-300">Bus</td>
                      <td className="py-2.5 px-3 text-slate-400">Gate #2</td>
            ...
            <div className="bg-slate-900/90 rounded-xl border border-slate-800 p-3 backdrop-blur-md flex flex-wrap items-center justify-between gap-3 text-xs font-mono">
              <div className="flex items-center gap-3">
                <span className="text-emerald-400 flex items-center gap-1 font-bold">
                  <CheckCircle2 className="w-3.5 h-3.5" /> ANPR Engine: ONLINE
                </span>
                <span className="text-slate-600">|</span>
                <span className="text-slate-400">Detector: ONLINE</span>
                <span className="text-slate-600">|</span>
                <span className="text-slate-400">OCR: ONLINE</span>
                <span className="text-slate-600">|</span>
        ...
        {activeTab === 'dataset' && (
          <div className="bg-slate-900/60 rounded-xl border border-slate-800 overflow-hidden backdrop-blur-md space-y-4 p-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-800 pb-3">
              ...
              <div className="relative w-full sm:w-72">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-4 py-1.5 bg-slate-950 border border-slate-800 rounded-lg text-xs text-white placeholder-slate-500 focus:outline-none focus:border-cyan-500"
                />
              </div>
            </div>
            {detectionsFeedLoading ? (
              <div className="p-12 text-center text-slate-500">Loading dataset feed...</div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {detectionsFeedData?.items?.map((item) => (
                  <div key={item.id} className="bg-slate-950/90 rounded-xl p-4 border border-slate-800 space-y-3 hover:border-cyan-500/40 transition-all">
                    ...
                    <div className="flex gap-3 text-xs">
                      {item.cropped_plate_path ? (
                        <img
                          ...
                          alt="Plate Crop"
                          className="w-24 h-12 object-contain bg-slate-900 border border-slate-800 rounded"
                          onError={(e) => { e.target.style.display = 'none'; }}
                        />
                      ) : (
                        <div className="w-24 h-12 bg-slate-900 border border-slate-800 rounded flex items-center justify-center text-[10px] text-slate-600 font-mono">
                          NO CROP
                        </div>
                      )}
                      <div className="flex-1 space-y-1 text-[11px] text-slate-400">
                        <p><span className="text-slate-500">Confidence:</span> <span className="font-mono text-cyan-300 font-bold">{(item.confidence * 100).toFixed(1)}%</span></p>
                        <p><span className="text-slate-500">Type:</span> {item.vehicle_type_detected || 'Vehicle'}</p>
                        <p className="truncate"><span className="text-slate-500">File:</span> {item.source_filename}</p>
                      </div>
                    </div>
                    <div className="bg-slate-900/60 rounded p-2 text-[10px] space-y-1 text-slate-400 border border-slate-800/80">
                    ...
                    {vehiclesData?.items?.map((vehicle) => (
                      <tr key={vehicle.id} className="hover:bg-slate-800/40 transition-colors">
                        <td className="px-6 py-4">
                          ...
                          <span className="ml-2 text-slate-500">{vehicle.vehicle_type}</span>
                        </td>
                        <td className="px-6 py-4 text-slate-400 text-[10px]">{vehicle.vehicle_type_detected || '-'}</td>
      ...
      >
        <div className="space-y-3 text-xs max-h-96 overflow-y-auto">
          {detectionsData?.items?.length === 0 ? (
            <p className="text-slate-500 text-center py-4">No detection records.</p>
          ) : (
            detectionsData?.items?.map((det) => (
              <div key={det.id} className="bg-slate-950 rounded-lg p-3 border border-slate-800 space-y-1.5">
                <div className="flex items-center justify-between">
                ...
                {det.vehicle_type_detected && (
                  <p className="text-[10px] text-slate-500">Type: {det.vehicle_type_detected}</p>
                )}
