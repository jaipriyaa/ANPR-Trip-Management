      ...
      <main className="flex-1 p-6 space-y-6 overflow-y-auto">
        ...
        <div className="flex items-center justify-between bg-slate-900/80 rounded-xl p-4 border border-slate-800 backdrop-blur-md">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-sm font-bold text-white">Executive Control Room Analytics</h2>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3">
          ...
          <div className="bg-slate-900/60 rounded-xl p-3 border border-cyan-500/30 backdrop-blur-md">
            <p className="text-[10px] text-slate-400 font-semibold uppercase tracking-wider">Currently Inside</p>
          ...
          <div className="bg-slate-900/60 rounded-xl p-3 border border-amber-500/30 backdrop-blur-md">
            <p className="text-[10px] text-slate-400 font-semibold uppercase tracking-wider">Avg Stay Duration</p>
          ...
          <div className="bg-slate-900/60 rounded-xl p-3 border border-emerald-500/30 backdrop-blur-md">
            <p className="text-[10px] text-slate-400 font-semibold uppercase tracking-wider">OCR Accuracy</p>
            ...
            <div className="grid grid-cols-7 gap-2 pt-4 text-center font-mono">
              {(charts.accuracy_trend || []).map((a, i) => (
                <div key={i} className="space-y-2">
                  <div className="h-24 flex items-end justify-center bg-slate-950 rounded-lg p-1 border border-slate-800">
                    <div
                  ...
                  <p className="text-[10px] text-slate-400">{a.day}</p>
