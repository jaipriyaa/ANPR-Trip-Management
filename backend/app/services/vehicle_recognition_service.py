...
class VehicleRecognitionService:
    ...
    def process_upload(
        ...
        res = {
            ...
            "plate_text": plate_text or ai_result.get("plate_text") or ai_result.get("raw_text"),
            "display_plate": plate_text or ai_result.get("plate_text") or ai_result.get("raw_text") or "REQUIRES MANUAL REVIEW",
            "plate_number": plate_text or ai_result.get("plate_text") or ai_result.get("raw_text"),
            ...
            "annotated_image_path": ai_result.get("annotated_image_path"),
